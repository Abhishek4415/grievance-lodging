...
const  Nodal = () => {
    const [issues, setIssues] = useState([
        ...
        { id: 2, citizenName: 'Jane Smith', department: 'Health', description: 'Garbage not collected', status: 'Old' },
    ...
    const handleCreatePath = () => {
        // Logic to create a new path (e.g., category) for issues
        alert(`Path created: ${newPath}`);
        setNewPath('');
    };
    ...
    return (
        <div className="nodal-officer">
    <Navigation/>

            <h2>Nodal Officer Dashboard</h2>
            ...
            <div className="issue-section">
                ...
                <table className="issue-table">
                    ...
                    <tbody>
                        {issues.filter(issue => issue.status === 'Old').map(issue => (
                            <tr key={issue.id}>
                                <td>{issue.id}</td>
                                <td>{issue.citizenName}</td>
                                <td>{issue.department}</td>
            ...
            <div className="create-path">
                ...
                <input 
                    type="text" 
                    placeholder="Enter new path/category" 
                    value={newPath} 
